...
const props = defineProps({
    ...
    positions: Array,
    motivos: Array,
    employeeOvertimeEstimate: Object,
    schedules: Array,
});

const { showSuccess, showError } = useToastService();

console.log(props.employeeOvertimeEstimate);

const form = useForm({
    branch_office_id: props.employeeOvertimeEstimate?.branch_office_id,
    week: props.employeeOvertimeEstimate?.week,
    position_id: props.employeeOvertimeEstimate?.position_id,
    number_employees: props.employeeOvertimeEstimate?.number_employees,
    complete_turn: props.employeeOvertimeEstimate?.complete_turn,
    schedule_id: props.employeeOvertimeEstimate?.schedule_id,
    current_turn: props.employeeOvertimeEstimate?.current_turn,
    overtime: props.employeeOvertimeEstimate?.overtime,
    double_overtime: props.employeeOvertimeEstimate?.double_overtime,
    triple_overtime: props.employeeOvertimeEstimate?.triple_overtime,
    motivo: props.employeeOvertimeEstimate?.motivo,
    coment: props.employeeOvertimeEstimate?.coment,
});
...
const submit = () => {
    form.put(
        "/employee/employee-overtime-estimates/" +
            props.employeeOvertimeEstimate.id,
        {
            preserveScroll: true,
            onSuccess: () => {
                showSuccess();
        ...
        <form @submit.prevent="submit" class="p-fluid">
            <div class="flex gap-4 mb-5">
                ...
                <div class="flex-1 flex flex-column gap-2">
                    ...
                    />
                    <small class="p-error" v-if="form.errors.week">{{
                        form.errors.week
                    }}</small>
                </div>
                ...
                <div class="flex-1 flex flex-column gap-2">
                    ...
                    />
                    <small class="p-error" v-if="form.errors.position_id">{{
            ...
            <div class="surface-50 p-4 surface-border mb-5">
                ...
                <div class="flex gap-4 align-items-start mb-4">
                    ...
                    <div class="flex-1 flex flex-column gap-2">
                        ...
                        />
                        <small class="p-error" v-if="form.errors.overtime">{{
            ...
            <div class="flex gap-4 mb-5">
                <div class="w-full flex flex-column gap-2">
                    ...
                    <Select
                        ...
                        filter
                    />
                    <small class="p-error" v-if="form.errors.motivo">{{
                        form.errors.motivo
                    }}</small>
                </div>
            </div>
