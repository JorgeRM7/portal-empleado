...
const deleteItem = async () => {
    ...
    try {
        const response = await axios.delete(
            route("payroll-accounts.destroy", itemToDelete.value.id)
        );
        ...
        <div class="card">
            <Toolbar>
                ...
                <template #end>
                    ...
                    <Link :href="route('payroll-accounts.create')">
                        <Button
                            label="Crear"
                    ...
                    <template #body="{ data }">
                        ...
                        <div v-else>
                            <Button
                                ...
                                @click="
                                    () => {
                                        router.get(`/payroll/payroll-accounts/${data.id}/edit`);
                                    }
                                "
                            />
                            <Button
                            ...
                            <Button
                                ...
                                rounded
                                @click="() => {
                                    router.get(route('payroll-accounts.show', data.id));
                                }"
                            />
