...
const submitForm = () => {
    ...
    form.put(`/catalogs/schedules/${props.Schedules.id}`, {
        preserveScroll: true,
        onSuccess: () => {
        ...
        <div>
            ...
            <div class="card">
                    ...
                    <Panel class="mb-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                            ...
                            <div class="field mb-4">
                                ...
                                <InputText id="nombre" v-model="form.name" placeholder="Ej. 12 X 12"
                            ...
                            <div class="field">
                                ...
                                <InputText type="time" id="entry_time" v-model="form.entry_time" timeOnly placeholder="Ej. 09:00"
                                    class="w-full" :invalid="!!frontErrors.entry_time"
                            ...
                            <div class="field">
                                ...
                                <InputText type="time" id="leave_time" v-model="form.leave_time" timeOnly placeholder="Ej. 18:00"
                                    class="w-full" :invalid="!!frontErrors.leave_time"
                            ...
                            <div class="field">
                                ...
                                <InputNumber id="normal_double_overtime" v-model="form.normal_double_overtime"
                            ...
                            <div class="field">
                                ...
                                <InputNumber id="normal_triple_overtime" v-model="form.normal_triple_overtime"
                    ...
                    <Panel class="mb-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div class="field">
                                ...
                                <InputNumber id="tolerance_before_entry_time" v-model="form.tolerance_before_entry_time"
                            ...
                            <div class="field">
                                ...
                                <Select id="tolerance_before_entry_type" v-model="form.tolerance_before_entry_type"
                            ...
                            <div class="field">
                                ...
                                <InputNumber id="tolerance_after_entry_time" v-model="form.tolerance_after_entry_time"
                            ...
                            <div class="field">
                                ...
                                <Select id="tolerance_after_entry_type" v-model="form.tolerance_after_entry_type"
                                    :options="toleranceTypeOptions" optionLabel="label" optionValue="value"
                                    placeholder="Seleccione una opción" class="w-full"
                            ...
                            <div class="field">
                                ...
                                <InputNumber id="tolerance_before_leave_time" v-model="form.tolerance_before_leave_time"
                            ...
                            <div class="field">
                                ...
                                <Select id="tolerance_before_leave_type" v-model="form.tolerance_before_leave_type"
                                    :options="toleranceTypeOptions" optionLabel="label" optionValue="value"
                                    placeholder="Seleccione una opción" class="w-full"
                            ...
                            <div class="field">
                                ...
                                <InputNumber id="tolerance_after_leave_time" v-model="form.tolerance_after_leave_time"
                            ...
                            <div class="field">
                                ...
                                <Select id="tolerance_after_leave_type" v-model="form.tolerance_after_leave_type"
                                    :options="toleranceTypeOptions" optionLabel="label" optionValue="value"
                                    placeholder="Seleccione una opción" class="w-full"
                    ...
                    <Panel class="mb-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="field">
                                ...
                                <InputNumber id="double_overtime" v-model="form.double_overtime" placeholder="Ej. 3"
                            ...
                            <div class="field">
                                ...
                                <InputNumber id="double_overtime_hour_value" v-model="form.double_overtime_hour_value"
                            ...
                            <div class="field">
                                ...
                                <InputNumber id="triple_overtime" v-model="form.triple_overtime" placeholder="Ej. 4.5"
                            ...
                            <div class="field">
                                ...
                                <InputNumber id="triple_overtime_hour_value" v-model="form.triple_overtime_hour_value"
                                    placeholder="Ej. 0" class="w-full"
                    ...
                    <Panel class="mb-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div class="field">
                                ...
                                <InputNumber id="tolerance_overtime_before_entry_time"
                            ...
                            <div class="field">
                                ...
                                <Select id="tolerance_overtime_before_entry_type"
                            ...
                            <div class="field">
                                ...
                                <InputNumber id="tolerance_overtime_after_entry_time"
                            ...
                            <div class="field">
                                ...
                                <Select id="tolerance_overtime_after_entry_type"
                            ...
                            <div class="field">
                                ...
                                <InputNumber id="tolerance_overtime_before_leave_time"
                            ...
                            <div class="field">
                                ...
                                <Select id="tolerance_overtime_before_leave_type"
                            ...
                            <div class="field">
                                ...
                                <InputNumber id="tolerance_overtime_after_leave_time"
                            ...
                            <div class="field">
                                ...
                                <Select id="tolerance_overtime_after_leave_type"
                ...
                <div class="flex justify-end gap-3 pt-2">
                    <Button label="Cancelar" icon="pi pi-times" severity="secondary" @click="cancel"
