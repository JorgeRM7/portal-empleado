...
const submitForm = () => {
    ...
    form.put(`/catalogs/policies/${props.EmployeePolicy.id}`, {
        preserveScroll: true,
        onSuccess: () => {
                ...
                <div class="mb-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div class="field mb-4">
                            ...
                            <InputText id="nombre" v-model="form.name" placeholder="Ej. regla para vacaciones"
                        ...
                        <div class="field">
                            ...
                            <InputNumber id="week_work_days" v-model="form.week_work_days"
                        ...
                        <div class="field">
                            ...
                            <InputNumber id="vacation_bonus" v-model="form.vacation_bonus"
                        ...
                        <div class="flex align-items-center mb-4">
                            <div class="card w-full shadow-none p-3">
                                <div class="flex align-items-center justify-content-between">
                                    ...
                                    <ToggleSwitch v-model="form.vacation_bonus_year" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex align-items-center mb-4">
                            <div class="card w-full shadow-none p-3">
                                <div class="flex align-items-center justify-content-between">
                                    ...
                                    <ToggleSwitch v-model="form.absences_discount" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex align-items-center mb-4">
                            <div class="card w-full shadow-none p-3">
                                <div class="flex align-items-center justify-content-between">
                                    ...
                                    <ToggleSwitch v-model="form.incidences_discount" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mb-4">
                                ...
                                <div class="card p-3">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 p-shadow-2">
                                        ...
                                        <div class="field">
                                            ...
                                            <InputNumber :id="`days-${index}`" v-model="regla.days" placeholder="Ej. 14"
                                                class="w-full"
                                        ...
                                        <div class="field">
                                            ...
                                            <Select :id="`years-${index}`" v-model="regla.years"
                                    ...
                                    <div class="flex align-items-center mt-3">
                                        <Button v-if="form.vacations.length > 1" icon="pi pi-trash" severity="danger"
                                            text class="p-button-rounded p-button-sm ml-auto"
                        ...
                        <Button label="Agregar regla" icon="pi pi-plus" class="p-button-outlined mt-2"
                            @click="addRegla" />
                    </div>
                </div>
