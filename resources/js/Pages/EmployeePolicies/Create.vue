                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div class="field mb-4">
                            ...
                            <InputText 
                                id="nombre" 
                                v-model="form.name" 
                                placeholder="Ej. regla para vacaciones" 
                        ...
                        <div class="field">
                            ...
                            <InputNumber
                                id="week_work_days"
                                v-model="form.week_work_days"
                                placeholder="Ej. valor de 0 a 8"
                                class="w-full"
                                :inputClass="{ 'p-invalid': frontErrors.week_work_days }"
                                :min="0"
                                :max="8"
                                :step="1"
                                locale="en-US"
                                @blur="clearReglaError(index, 'week_work_days')"
                            />
                            <Message
                                v-if="frontErrors.week_work_days"
                                severity="error"
                                size="medium"
                                variant="simple"
                            >
                        ...
                        <div class="field">
                            ...
                            <InputNumber
                                id="vacation_bonus"
                                v-model="form.vacation_bonus"
                                placeholder="Ej. 0.3, valor entre 0 y 1"
                                class="w-full"
                                :inputClass="{ 'p-invalid': frontErrors.vacation_bonus }"
                                :min="0"
                                :max="1"
                                :step="0.01"
                                :minFractionDigits="1"
                            ...
                            />
                            <Message
                                v-if="frontErrors.vacation_bonus"
                                severity="error"
                                size="medium"
                                variant="simple"
                            >
                                ...
                                <div class="card p-3">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 p-shadow-2">
                                        ...
                                        <div class="field">
                                            ...
                                            />
                                            <Message
                                                v-if="frontErrors.vacations?.[index]?.days"
                                                severity="error"
                                                size="medium"
                                                variant="simple"
                                            >
                                        ...
                                        <div class="field">
                                            ...
                                            />
                                            <Message
                                                v-if="frontErrors.vacations?.[index]?.years"
                                                severity="error"
                                                size="medium"
                                                variant="simple"
                                            >
