...
const BANNED_WORDS = [
    // directos
    'pendejo', 'pendeja', 'pndjo', 'p3ndejo',
    'idiota', 'imbecil', 'estupido', 'inutil', 'baboso',
    'culero', 'qlero',
    'cabron', 'cabrón', 'c4br0n',
    'puto', 'p*to',
    'perra', 'perro',
    ...
    'chingas', 'chingue', 'chinguen', 'ch1ng4', 'chngd',

    // verga
    'verga', 'v3rga', 'vrg',
    'a la verga', 'valio verga', 'valió verga', 'me vale verga',
                    ...
                    <div class="flex justify-center gap-2 mt-3">
                        <Button
                            ...
                            :disabled="
                                ...
                                complaintDescription.length > 300 ||
                                !selectedOption ||
                                (selectedOption?.code === 'OTR' && !otherSubject.trim())
                            "
                            @click="mejorarTexto"
                        />
