...
<body>
  <div class="header">
    ...
    <div class="header-right">
      <div class="folio">Folio: <strong>VAC-{{ $folio }}</strong></div>
  ...
  <div class="request-box">
    ...
    <p class="request-text">
      Solicito <span class="pill">{{ $dias }} días</span> de vacaciones del
      <span class="pill">{{ $desde }}</span> al <span class="pill">{{ $hasta }}</span>.
      Deberá presentarse el día <span class="pill">{{ $presentarse }}</span>.
    </p>
    <div class="footnote">
      Nota: La autorización está sujeta a la aprobación del jefe inmediato y Recursos Humanos.
    </div>
  </div>
  ...
  <table class="summary" style="margin-top: 14px;">
    <tr>
      <td>
        ...
        <div class="value accent">{{ $dias }}</div>
      </td>
      <td>
